...
/* This file is a verbatim copy of SDL 1.2's, as most of it is covered by
SGI Free Software License B, Version 1.1 and not LGPL, and the rest was
written by Sam Lantinga. The only exceptions are patches for doxygen comments
and a MacOS Classic #include fix; both were from external contributors and
both were removed here. */
